...
class Tvbox_model extends CI_Model {
	private $table_name = 'Tvbox_tbl';
	private $fields_pk = 't_pk';
	...
	public function insert_Tvbox_for_data($data) {
		$this->w_db->insert ( $this->table_name, $data );
		$id = $this->w_db->insert_id ();
		// echo $this->w_db->last_query();
		return $id;
	}
	public function update_Tvbox_for_data($pk, $data) {
	...
	public function get_row_Tvbox_by_pk($select, $pk) {
		if (! empty ( $select )) {
